    ...
    >
      ...
      <div className="flex-1 flex overflow-hidden px-2 pb-2 gap-2">
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-white/[0.03] border border-white/10 rounded-2xl">
          <div className="p-3 flex flex-col items-center gap-3">
            ...
            {!isWatching && <AutomaticToggle automatic={automatic} onToggle={onToggleAutomatic} />}
          </div>
      ...
      <div className="px-3 pt-2 pb-20 grid grid-cols-3 gap-2">
        ...
        {isWatching ? (
          <button
            disabled
            className="bg-white/[0.03] text-gray-500 py-3 rounded-xl font-black text-xs tracking-wider border border-white/5 cursor-not-allowed"
          >
            WATCHING
          </button>
        ) : (
          <button
            ...
            className="bg-bingo-accent text-white py-3 rounded-xl font-black text-xs tracking-wider shadow-[0_8px_20px_-8px_rgba(139,92,246,0.6)] active:scale-[0.98] transition-transform"
          >
            BINGO!
          </button>
        )}
